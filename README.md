...
![pfSense Firewall Configuration](pfsense-firewall-configuration.png)
* **Network Security Groups (Azure):** Applied the principle of **Implicit Deny** on the cloud perimeter. Inbound rules on the Azure VM were strictly IP-whitelisted, meaning Ports 22 (SSH), 443 (Dashboard), 1514, and 1515 drop all packets that do not originate from my home's public IP address.
![Microsoft Azure NSG Configuration](microsoft-azure-nsg-configuration.png)
